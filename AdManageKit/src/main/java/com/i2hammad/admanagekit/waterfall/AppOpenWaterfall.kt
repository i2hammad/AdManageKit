 ...
 * delivered: [AppOpenAdProvider.AppOpenShowCallback.onAdDismissed] after a
 * successful show, or [AppOpenAdProvider.AppOpenShowCallback.onAdFailedToShow]
 * when the show fails.
 *
 ...
 */
class AppOpenWaterfall @JvmOverloads constructor(
     ...
     *
     * Exactly one terminal callback is delivered per call: [AppOpenAdProvider.AppOpenShowCallback.onAdDismissed]
     * after a successful show, or [AppOpenAdProvider.AppOpenShowCallback.onAdFailedToShow] on failure.
     */
    fun show(activity: Activity, callback: AppOpenAdProvider.AppOpenShowCallback) {
        ...
        provider.showAd(activity, adUnitId, object : AppOpenAdProvider.AppOpenShowCallback {
