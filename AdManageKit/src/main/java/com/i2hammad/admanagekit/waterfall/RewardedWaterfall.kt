 ...
 * delivered: [RewardedAdProvider.RewardedShowCallback.onAdDismissed] after a
 * successful show, or [RewardedAdProvider.RewardedShowCallback.onAdFailedToShow]
 * when the show fails.
 *
 ...
 */
class RewardedWaterfall @JvmOverloads constructor(
     ...
     *
     * Exactly one terminal callback is delivered per call: [RewardedAdProvider.RewardedShowCallback.onAdDismissed]
     * after a successful show, or [RewardedAdProvider.RewardedShowCallback.onAdFailedToShow] on failure.
     */
    fun show(activity: Activity, callback: RewardedAdProvider.RewardedShowCallback) {
        ...
        provider.showAd(activity, adUnitId, object : RewardedAdProvider.RewardedShowCallback {
