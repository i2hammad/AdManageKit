...
final class AdPreloadingSnippets {

  private static final String TAG = "AdPreloadingSnippets";
  ...
  private void startPreloadingWithCallback(String adUnitId) {
    PreloadCallback preloadCallback =
        ...
        new PreloadCallback() {
          @Override
          public void onAdFailedToPreload(@NonNull String preloadId, LoadAdError adError) {
            Log.e(
                TAG,
                String.format(
