...
/** An [AdFragment] subclass that loads a rewarded ad. */
public class RewardedFragment extends AdFragment<FragmentRewardedBinding> {
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    // Configure the "Watch video" button.
    binding.watchVideoButton.setVisibility(View.INVISIBLE);
  ...
  /** Load a new rewarded ad if one isn't already loaded. */
  private void loadAd() {
    if (rewardedAd != null) {
    ...
    RewardedAd.load(
        ...
        new AdLoadCallback<RewardedAd>() {
          ...
          public void onAdLoaded(@NonNull RewardedAd rewardedAd) {
            RewardedFragment.this.rewardedAd = rewardedAd;
    ...
    countDownTimer =
        new CountDownTimer(milliseconds, COUNTDOWN_INTERVAL) {
          ...
          public void onFinish() {
            ...
            if (rewardedAd != null) {
              binding.watchVideoButton.setText(
                  getResources()
                      .getQuantityString(
                          R.plurals.watch_video_coins,
